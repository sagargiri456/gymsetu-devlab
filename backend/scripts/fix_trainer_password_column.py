#!/usr/bin/env python3
"""
Quick script to fix the password column length in the trainer table.
...
try:
    ...
    print("=" * 60)
    print("Fixing password column length in trainer table")
    print("=" * 60)
    ...
    with app.app_context():
        try:
            ...
            if current_length:
                ...
                print("   ⚠ Password column not found in trainer table")
                print("\n   Please run this SQL manually:")
                print("   ALTER TABLE trainer ALTER COLUMN password TYPE VARCHAR(255);")
